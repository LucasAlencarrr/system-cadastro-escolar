...
Framework Web: FastAPI (ou similar utilizado em aula)

Banco de Dados: SQLite (para desenvolvimento local) e suporte para PostgreSQL.
...
Deploy e Escalabilidade: Preparação do ambiente para integração com frameworks modernos de alta performance.

Nota: Este sistema marca a transição entre o desenvolvimento lógico básico e a criação de aplicações web robustas e persistentes.
